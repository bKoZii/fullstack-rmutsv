    ...
    <div class="col-md-6 banner-left pt-md-0 pt-5 pb-md-0 pb-sm-4">
      <div class="container pt-md-0 pt-5">
        <div class="banner-info ps-xxl-5 ps-xl-0 ps-5 ms-lg-5 py-md-0 py-5">
          ...
          <h3 class="mb-1">ชมรมคนชอบ FullStack</h3>
          <p>มาเรียนรู้การพัฒนาเว็บไซต์แบบ FullStack ด้วยภาษา PHP กัน!</p>
    ...
    <div class="testi-wrap">
      <div class="client-single active position-1" data-position="position-1">
        <div class="client-img">
          <img src="assets/images/konkamon.jpg" alt=""/>
        </div>
        <div class="client-info">
          <h3>Konkamon Sion</h3>
          <!-- <p>นักพัฒนาเว็บไซต์ด้วย Nuxt.js</p> -->
        </div>
        <div class="client-comment">
          <h3>สวัสดีครับ ท่านสมาชิกชมรมคนชอบ Nuxt วันพระวันเจ้าไม่เว้นกันเลย อยากจะเขียนแต่ Nuxt ไม่เข้าใจจริงๆ เลย
            ทั้งเด็กทั้งผู้ใหญ่ ตะโกนหาสรรหาแต่ Nuxt เป็นอะไรกัน! เฮ้ย! ทั้งวันเลยวันนี้ ทำงานมีแต่ Nuxt
            โผล่มาทั้งวันเลย เขียนไปแล้วก็ยังจะอยากเขียนอีก มันหมายความว่าไงเนี่ยคนที่ไหนคนจังหวัดอะไรพวกท่านเนี่ย หืม?
          </h3>
